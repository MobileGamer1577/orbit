...
//  gesteuert direkt über AppSettingsStore.instance.
//
// ══════════════════════════════════════════════════════════════
...
class _Rebirth {
  ...
  const _Rebirth({required this.level, required this.credits, required this.droids});
}
...
class _DroidTycoonScreenState extends State<DroidTycoonScreen> {
  // Liest direkt aus AppSettingsStore.instance
  bool get _animRainbow => AppSettingsStore.instance.animRainbow;
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('🤖 Droid Tycoon',
                              style: TextStyle(
                                  fontSize: 24,
                                  fontWeight: FontWeight.w900,
                                  color: Colors.white,
                                  letterSpacing: -0.3)),
                          Text('Star Wars Droid Tycoon · Rebirth Guide',
                              style: TextStyle(
                                  fontSize: 12,
    ...
    return Row(
      ...
      children: [
        AnimatedBuilder(
          animation: _ctrl,
          builder: (_, __) {
            final color = HSVColor.fromAHSV(1.0, _ctrl.value * 360, 1.0, 1.0).toColor();
          ...
          children: [
            ...
            Container(
              ...
              child: Column(children: [
                ...
                Text('RB', textAlign: TextAlign.center,
                    style: TextStyle(color: accentColor.withOpacity(0.65),
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: rebirth.droids
                        .map((d) => _DroidChip(droid: d, animRainbow: animRainbow))
                        .toList(),
                  ),
                ],
              ),
  ...
  Widget build(BuildContext context) {
    return RepaintBoundary(
      child: AnimatedBuilder(
        animation: _ctrl,
        builder: (_, __) {
          final color  = HSVColor.fromAHSV(1.0, _ctrl.value * 360, 0.85, 1.0).toColor();
          final color2 = HSVColor.fromAHSV(
              1.0, (_ctrl.value * 360 + 60) % 360, 0.85, 1.0).toColor();
          return Container(
            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
            decoration: BoxDecoration(
