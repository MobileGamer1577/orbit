  ...
  DateTime get nextStart {
    ...
    switch (recurrence) {
      ...
      case _Recurrence.fixedTimesDaily:
        ...
        return DateTime(now.year, now.month, now.day, firstH, 0)
...
class _MapCode {
  ...
  const _MapCode({required this.label, required this.code, required this.description});
...
const List<_MapCode> _kCodes = [
  _MapCode(
    label: 'Hauptinsel', code: '1499-6977-1308',
    description:
...
// ── Events ─────────────────────────────────────────────────────
//
//  ✏️  HIER Events anpassen wenn sich Zeiten ändern.
//
const List<_MapEvent> _kEvents = [
  ...
  // Easter: jeden Sonntag 20:00, 30 Min
  _MapEvent(
    name: '🐇 Easter Event',
  ...
  // Valentine's: täglich 01:00 + 05:00 + 09:00 + 13:00 + 17:00 + 21:00, 20 Min
  _MapEvent(
    name: '💘 Valentine\'s Event',
    color: Color(0xFFFF4081),
    recurrence: _Recurrence.fixedTimesDaily,
    fixedHours: [1, 5, 9, 13, 17, 21],
    durationMinutes: 20,
  ),
  ...
  _MapEvent(
    ...
    weekday: 3,  // Mittwoch
    hour: 23, minute: 0,
    durationMinutes: 0,  // keine Laufzeit angegeben
  ),
];
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _DetailCard(
                        ...
                        subtitle: '${_kCodes.length} ${l10n.kreativMapCodesCount}',
        ...
        child: Column(
          ...
          children: [
            ...
            Row(children: [
              ...
              Expanded(
                child: Text(event.scheduleLabel(l10n),
                    style: TextStyle(
                        color: Colors.white.withOpacity(0.55),
                        fontSize: 13,
                        fontWeight: FontWeight.w600)),
                                ...
                                ? GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                            color: _kAccentColor.withOpacity(0.40)),
                                      ),
                                      child: Row(children: [
                                        Icon(Icons.tag, size: 18, color: _kAccentColor),
                                        const SizedBox(width: 10),
                                        Expanded(
                                          child: Text(mc.code,
                                              style: TextStyle(
                                        ...
                                        Icon(Icons.copy_rounded,
                                            size: 18,
                                            color: _kAccentColor.withOpacity(0.70)),
                                      ]),
                                    ),
                                  )
                                : Container(
